...
namespace UniTrendChart.Drawing
{
    public class Plot : FrameworkElement
    {
        ...
        {
            isData = true;
            //if (bitmap.PixelWidth != 700 || bitmap.PixelHeight != 200)
            //{
            //    bitmap = new WriteableBitmap(700, 200, 96, 96, System.Windows.Media.PixelFormats.Pbgra32, null);
            //    dc.DrawImage(bitmap, new Rect(0, 0, (int)RenderSize.Width, (int)RenderSize.Height));
            //    base.OnRender(dc);
            //}
            //IsCursorTimeVisible = false;
            //IsCursorVoltageVisible = false;
